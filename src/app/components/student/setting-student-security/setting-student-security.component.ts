...
@Component({
  selector: 'app-setting-student-security',
  templateUrl: './setting-student-security.component.html',
  styleUrls: ['./setting-student-security.component.scss']
})
export class SettingStudentSecurityComponent implements OnInit {
