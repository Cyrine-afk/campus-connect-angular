  ...
  public sideBar: any = [
    ...
    },
    {
      ...
      menu: [
        {
          menuValue: 'Student',
          // route: '/student/student-view/students-list',
          hasSubRoute: true,
          showSubRoute: false,
          base: 'student',
          page: 'student-view',
        ...
        {
          menuValue: 'Student Profile',
          route: routes.students_edit_profile,
          hasSubRoute: false,
          showSubRoute: false,
          base: 'student',
          page: 'setting-edit-profile',
          last: '',
          subMenus: [],
        },
        {
          ...
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-security',
          last: '',
          subMenus: [],
        },
        {
          menuValue: 'Social Profile',
          route: routes.students_social_profile,
          hasSubRoute: false,
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-social-profile',
          last: '',
          subMenus: [],
        },
        {
          ...
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-notification',
          last: '',
          subMenus: [],
        },
        {
          ...
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-privacy',
          last: '',
          subMenus: [],
        },
        {
          menuValue: 'Link Accounts',
          route: routes.students_accounts,
          hasSubRoute: false,
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-accounts',
          last: '',
          subMenus: [],
        },
        {
        ...
        },
        {
          ...
          showSubRoute: false,
          base: 'student',
          page: 'setting-student-subscription',
          last: '',
          subMenus: [],
        },
        {
